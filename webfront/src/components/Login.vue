        ...
        self.$axios({
          ...
          .then(res => {
            if (res.data['code'] === 200) {
              ...
              // console.log(this.getObj('token'))
              // console.log(this.getObj('menus'))
              // console.log(this.getObj('permissions'))
              this.$router.push('/frametest') // 不是route.push！！！！
            } else {
              this.$message({
                type: 'error',
                message: '用户名或密码错误'
